...
class TestSGWTFunctionality(unittest.TestCase):
    ...
    def test_lowpass_bset_execution(self):
        ...
        bset = csc_matrix((np.ones(1), ([100], [0])), shape=(L.shape[0], 1))
    ...
    def test_vf_convolution(self):
        ...
        with sgwt.Convolve(L) as conv:
            ...
            res = conv.convolve(self.X, K)
            self.assertEqual(res.shape[0], L.shape[0])
            
            # Test with VFKern object
            vk = VFKern.from_dict(K)
    ...
    def test_vf_validation(self):
        ...
        with sgwt.Convolve(L) as conv:
            ...
            with self.assertRaises(ValueError):
                conv.convolve(self.X, VFKern(Q=None, R=None, D=None))
    ...
    def test_dy_vf_direct_term(self):
        ...
        with sgwt.DyConvolve(L, vk) as conv:
    ...
    def test_impulse_utility(self):
        ...
        imp = sgwt.impulse(L, n=5, ntime=2)
        self.assertEqual(imp.shape, (L.shape[0], 2))
