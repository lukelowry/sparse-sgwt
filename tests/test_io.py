...
class TestSGWTIo(unittest.TestCase):
    ...
    def test_kernel_loading(self):
        ...
        kernels = [sgwt.MEXICAN_HAT, sgwt.MODIFIED_MORLET, sgwt.SHANNON]
        for kjson in kernels:
            k = VFKern.from_dict(kjson)
            self.assertIsInstance(k, VFKern)
    ...
    def test_laplacian_loading(self):
        ...
        laps = [sgwt.DELAY_TEXAS, sgwt.IMPEDANCE_HAWAII, sgwt.LENGTH_WECC]
        for L in laps:
    ...
    def test_signal_loading(self):
        ...
        signals = [sgwt.COORD_TEXAS, sgwt.COORD_USA]
        for S in signals:
    ...
    def test_data_integrity_alignment(self):
        ...
        self.assertEqual(sgwt.DELAY_TEXAS.shape[0], sgwt.COORD_TEXAS.shape[0])
        self.assertEqual(sgwt.DELAY_USA.shape[0], sgwt.COORD_USA.shape[0])
    ...
    def test_vfkern_from_json_logic(self):
        ...
        kern = VFKern.from_dict(mock_data)
