...
The horse mesh (48,485 vertices) presents an elongated geometry with thin limbs and a complex torso. Using a higher filter order (50) at scale 90 yields a more sharply localized wavelet. The filter response, centered at vertex 40,000, demonstrates how wavelets adapt to the local surface geometry while respecting the mesh connectivity.
