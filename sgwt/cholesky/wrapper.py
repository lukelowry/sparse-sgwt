...
class CholWrapper:
    ...
    def sdmult(self, matrix_ptr, out_ptr, alpha: float = 1.0, beta: float = 0.0) -> None:
        """
    ...
    def numpy_to_chol_sparse(self, A: csc_matrix, itype: int = 0, dtype: int = 0) -> cholmod_sparse:
        """
